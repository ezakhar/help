...
В выполненной тренировке, загруженной с часов или со смартфона, доступны:
...
По каждой выполненной тренировке, по любому кругу, сегменту или произвольно выделенному на графике отрезку тренировки система рассчитает следующие показатели:

* [Расстояние]
* [Время] 
  * Прошедшее время (elapsed duration)
  * Общее время (duration)
  * Время в движении (moving duration)
* [Каденс]
* Показатели набора
  * Общий набор, 
  * набор высоты, 
...
### Набор высоты 
Staminity рассчитывает несколько показателей набора высоты на основании исходных данных, записанных часами или смартфоном во время тренировки. В каждой точке устройством фиксируется высота над уровнем моря и на 

* Общий набор (elevation) - сумма набора и потери высоты;
* Набор высоты (elevation gain) -  набор высоты за тренировку. 
* потеря высоты, 
* Градиент
