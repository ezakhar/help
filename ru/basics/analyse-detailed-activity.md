...
График откладывается по времени или по расстоянию, на нем отображаются следующие показатели:
* пульс;
* мощность;
* темп/скорость;
* высота;
...
Доступные действия с графиком:
* выбор режима графика: по времени или по расстоянию;
* управление набором показателей для отображения;
* управление сглаживанием графика;
![видео управление сглаживанием графика](/assets/video-template.png)
* 
