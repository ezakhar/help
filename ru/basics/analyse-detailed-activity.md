...
* **Время в движении** или **moving duration** - это количество секунд, в течение которых спортсмен двигался в течение тренировки. Для примера выше, если в течение 80 минут спортсмен два раза остановился на светофоре по 1 минуте, не выключая запись в часах, то moving duration будет равна 78 минутам.
