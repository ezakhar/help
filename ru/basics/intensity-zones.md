...
Чтобы рассчитать границы пульсовых зон по Янсену, введите значение ЧССмакс, выберите в настройках зон соответствующий метод расчета и сохраните изменения:  
