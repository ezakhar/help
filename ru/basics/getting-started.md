...
* Настроить профиль и тренировочные зоны
...
Переходите по адресу: [https://staminity.com](https://staminity.com) и нажимаете кнопку “Ста
...
Если выбран способ регистрации через e-mail, необходимо подтвердить почтовый адрес, перейдя по ссылке в письме. Если письмо не дошло, проверьте папку Спам.
