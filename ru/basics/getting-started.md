...
### Определите, как вы будете работать {#role}
...
> Регистрируйтесь без признака "Я-тренер" и подключайтесь к клубу. Тариф "Тренер" будет назначен клубом.
...
Роль пользователя в Стаминити определяется комбинацией подключенных тарифных планов, поэтому после регистрации в любой момент можно подключить нужный тариф.
