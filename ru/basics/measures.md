...
При разработке алгоритма расчета скорректированной мощности были использованы:
* книга Аллена и Коггана "Training and racing with a power meter"
* работы Ф.Скибы по количественной оценке интенсивности тренировок велосипедистов, бегунов и триатлетов.
