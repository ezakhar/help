...
### v2.1.13. 06.04.2018
Управление связкой плановых и фактических тренировок. Теперь отвязать и привязать неправильно сопоставленный факт и план можно и вручную:
* (new) Открепить факт от плана в тренировке;
* (new) Открепить факт от плана в этапе соревнования
* (new) Прикрепить факт к плану в тренировке
* (new) Прикрепить факт к плану в этапе соревнования.
...
![Виды спорта в Staminity](https://content.staminity.com/assets/images/categories/activity-types.png)
