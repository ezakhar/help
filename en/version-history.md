...
Теперь Staminity поддерживает концепцию периодизации и дает возможность запланировать сезон по мезоциклам. 
Используйте схему периодизации по Фрилу или создавайте свою.

* **(new) Соревнования**
Планируйте соревнования по триатлону, бегу, плаванию и велоспорту. Факт по каждому этапу сопоставится автоматически после загрузки тренировок, также можно ввести его вручную.
...
* **\(new\) Тренировочные зоны и ПАНО**.
  ...
  * Ведение [порога анаэробного обмена \(ПАНО\)](/basics/lactate-threshold.md) по показателям интенсивности и  видам спорта
...
* Создание плановых тренировок спортсменом и тренером
